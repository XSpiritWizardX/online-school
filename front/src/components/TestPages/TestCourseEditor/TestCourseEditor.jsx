        ...
        lessons: [
          {
            ...
            content: {
              ...
              notes:
                "HTML stands for HyperText Markup Language. It uses tags to structure content on web pages.",
              ...
              lessons: module.lessons.map((lesson, lIndex) =>
                lIndex === lessonIndex
                  ? {
                      ...
                      content: {
                        ...lesson.content,
                        sections: lesson.content.sections.map(
                          (section, sIndex) =>
                            sIndex === sectionIndex
                              ? { ...section, [field]: value }
                              : section,
            ...
            {courseData.modules.map((module, moduleIndex) => (
              <div key={moduleIndex} className="module">
                <div className="module-header">
                  <div
                    className="module-header-content"
                    onClick={() => toggleModule(moduleIndex)}
                  >
                    <span
                      className={`expand-icon ${expandedModules.has(moduleIndex) ? "expanded" : ""}`}
                    >
                      ▶
                    </span>
                    {editingItem === `module-${moduleIndex}` ? (
                      ...
                      <span
                        ...
                        onDoubleClick={() =>
                          setEditingItem(`module-${moduleIndex}`)
                        }
                      >
                        {module.title}
                      </span>
            ...
            <div className="lesson-settings">
              ...
              <div className="setting-group">
                ...
                <textarea
                  ...
                  value={
                    currentLessonContent.content?.resources?.join(
                      "\n",
                    ) || ""
                  }
                  onChange={(e) =>
