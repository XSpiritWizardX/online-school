...
export default function CourseInterface({
  ...
  // Sample course data with actual content
              ...
              sections: [
                {
                  title: "What is HTML?",
                  content:
                    "HTML stands for HyperText Markup Language. It's not a programming language, but rather a markup language that tells the web browser how to structure and display content on a web page.",
                },
                {
...
<body>
    ...
    <p>This is my first web page.</p>
                ...
                },
                {
                  ...
                  content:
                    "HTML elements are the building blocks of web pages. They are defined by tags, which are keywords enclosed in angle brackets.",
...
<div id="header" class="main-section">
    <p class="intro-text">Welcome to our website!</p>
                ...
                },
                {
                  ...
                  content:
                    "Practice creating a simple HTML page with the structure shown above. Include headings, paragraphs, links, and an image.",
                },
              ],
              notes:
                "HTML stands for HyperText Markup Language. It uses tags to structure content on web pages. Remember: most tags come in pairs - an opening tag and a closing tag.",
              resources: [
                "HTML Specification",
                "MDN HTML Guide",
          ...
          },
          {
            ...
            content: {
              video:
                "HTML Tags and Elements - Understanding the building blocks",
              description:
                "Dive deep into HTML tags and elements. Learn about opening and closing tags, attributes, and how to properly structure your HTML documents.",
              notes:
                "Remember: Every opening tag needs a closing tag (except for self-closing tags like <img> and <br>).",
              resources: [
                "HTML Tag Reference",
                "Semantic HTML Guide",
              ],
          ...
          },
          {
            ...
            content: {
              ...
              description:
                "Learn how to create forms that collect user input. We'll cover different input types, form validation, and best practices for accessibility.",
              notes:
                "Always use proper labels for form inputs to improve accessibility.",
              resources: [
        ...
        lessons: [
          {
            ...
            content: {
              ...
              description:
                "Understanding CSS syntax is crucial for styling web pages. Learn about selectors, properties, values, and how CSS cascades.",
              notes:
                "CSS follows the pattern: selector { property: value; }",
              resources: [
                "CSS Syntax Guide",
          ...
          },
          {
            ...
            content: {
              ...
              description:
                "Master CSS selectors to target exactly the elements you want to style. Learn about class selectors, ID selectors, and more advanced selector patterns.",
              notes:
          ...
          },
          {
            ...
            content: {
              ...
              description:
                "Flexbox revolutionized CSS layouts. Learn how to create flexible, responsive layouts with ease using flexbox properties.",
              notes:
                "display: flex; turns an element into a flex container. Use justify-content and align-items for alignment.",
        ...
        lessons: [
          {
            ...
            content: {
              video:
                "JavaScript Variables and Functions - Programming fundamentals",
              description:
                "Learn the building blocks of JavaScript programming. Understand how to declare variables, create functions, and work with different data types.",
              notes:
          ...
          },
          {
            ...
            content: {
              ...
              description:
                "The Document Object Model (DOM) allows JavaScript to interact with HTML elements. Learn how to select, modify, and create elements dynamically.",
              notes:
                "Use document.querySelector() to select elements and .textContent or .innerHTML to modify them.",
              resources: [
                "DOM API Reference",
          ...
          },
          {
            ...
            content: {
              video:
                "JavaScript Events - Responding to user interactions",
              description:
                "Events make web pages interactive. Learn how to handle clicks, form submissions, keyboard input, and other user interactions.",
              notes:
                "Always use addEventListener() instead of inline event handlers for better code organization.",
              resources: [
                "Event Reference",
  ...
  const selectLesson = (moduleIndex, lessonIndex) => {
    ...
    // Reset navigation visibility when selecting a lesson
  ...
  const handleMouseMove = (e) => {
    ...
    const courseInterface = document.querySelector(
      ".course-interface",
    );
  ...
  const handleScroll = (e) => {
    ...
    // Only show navigation if there's scrollable content AND user is
    // at bottom
  ...
  return (
    <div className="course-interface">
      ...
      <div
        ...
        style={{
          height: `calc(100vh - 80px - ${bottomSectionHeight}px)`,
        }}
      >
        ...
        >
          {currentLessonContent.content?.type === "text" ? (
            <div className="text-lesson">
              ...
              <div className="lesson-sections">
                {currentLessonContent.content.sections?.map(
                  (section, index) => (
              ...
              <div className="lesson-content">
                ...
                {currentLessonContent.content?.resources && (
                  <div className="lesson-resources">
                    <h3>Resources:</h3>
                    <ul>
                      {currentLessonContent.content.resources.map(
                        (resource, index) => (
          ...
          <div
            className={`content-navigation ${showNavigation ? "visible" : ""}`}
          >
            <button
      ...
      >
        ...
        <div
          ...
          style={{ height: `${bottomSectionHeight - 60}px` }}
        >
          {activeSection === "content" && (
            <div className="notes-section">
              ...
              <div className="lesson-notes">
                ...
                <p>
                  {currentLessonContent.content?.notes ||
                    "Take notes here..."}
                </p>
              </div>
              <textarea
          ...
          {activeSection === "questions" && (
            <div className="questions-section">
              ...
              <div className="question-item">
                <h4>
                  How do I apply what I learned in{" "}
                  {currentLessonContent.title}?
                </h4>
                <p>
                  Practice is key! Try building small projects that
                  incorporate the concepts from this lesson. Start
                  with simple examples and gradually increase
                  complexity.
                </p>
              </div>
              <div className="question-item">
                <h4>
                  ...
                  {currentLessonContent.moduleTitle}?
                </h4>
                <p>
                  Review the lesson notes and make sure you understand
          ...
          {activeSection === "assignments" && (
            <div className="assignments-section">
              ...
              <div className="assignment-item">
                <h4>
                  Practice Exercise: {currentLessonContent.title}
                </h4>
                <p>
                  Create a practical example using the concepts
              ...
              <div className="assignment-item">
                <h4>
                  Quiz: {currentLessonContent.moduleTitle}{" "}
                  Fundamentals
                </h4>
                <p>
