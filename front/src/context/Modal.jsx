...
export function ModalProvider({ children }) {
  ...
  const contextValue = {
    ...
    // function to set the callback function called when modal is
    // closing
    setOnModalClose,
...
export function Modal() {
  ...
  // If there is no div referenced by the modalRef or modalContent is
  // not a truthy value, render nothing:
  if (!modalRef || !modalRef.current || !modalContent) return null;

  // Render the following component to the div referenced by the
  // modalRef
